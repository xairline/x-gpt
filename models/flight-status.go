...
type FlightStatus struct {
	...
	Locations           []FlightStatusLocation `gorm:"foreignKey:FlightId;constraint:OnDelete:CASCADE;" json:"locations"`
	Events              []FlightStatusEvent    `gorm:"foreignKey:FlightId;constraint:OnDelete:CASCADE;" json:"events"`
